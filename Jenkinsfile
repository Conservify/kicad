        ...
        stage ('boms') {
            dir ("tools") {
                withPythonEnv('python') {
                    ...
                    pysh "python update-schematic-fields.py --bom ../fk-core.sch ../fk-naturalist.sch ../fk-naturalist-sensors.sch ../fk-sonar.sch ../fk-atlas.sch ../fk-weather.sch ../fk-weather-sensors.sch"
